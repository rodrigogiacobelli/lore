---
id: tech-spec-draft
title: Produce structured Tech Spec Draft from PRD
summary: Makes concrete architectural decisions from the PRD. Produces a technical specification specific enough for implementation, with every decision traced to a product requirement.
---

# Architect — Tech Spec Draft
...
- Read every doc the technical-map references.
...
- The template: `lore artifact show fi-tech-spec-draft`

## Steps

Produce a structured Tech Spec Draft:
...
Create the doc via: `lore codex new <feature-slug>-tech-spec-draft --group transient -f <draft>` with proper frontmatter.
...
```
lore board add <tech-spec-review-mission-id> "Tech Spec Draft ready: lore codex show <id>"
```
...
The Tech Spec Draft, to tech-spec-review.
