...
- Doctrine (lore codex show conceptual-entities-doctrine) — a design document lists the artifacts its workflow uses in an `## Artifacts` section, and a mission body names an artifact id where it retrieves one
