...
related: ["tech-overview", "standards-dry", "standards-single-responsibility", "standards-dependency-inversion", "tech-arch-project-root-detection", "conceptual-workflows-oracle", "tech-arch-schemas"]
---
...
|      |  +-- *.yaml            # One file per schema, $id lore://schemas/<kind>
